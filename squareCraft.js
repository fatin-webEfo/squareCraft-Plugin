(async function squareCraft() {
  ...
  function createWidget() {
    ...
    widgetContainer.innerHTML = `
     <div
    class="squareCraft-p-4 squareCraft-poppins squareCraft-text-color-white squareCraft-border squareCraft-border-solid squareCraft-border-3d3d3d squareCraft-bg-color-2c2c2c squareCraft-rounded-15px squareCraft-w-300px">
...
class="squareCraft-flex squareCraft-universal squareCraft-col-span-8 squareCraft-cursor-pointer squareCraft-rounded-6px squareCraft-justify-between squareCraft-border squareCraft-border-solid squareCraft-border-585858 squareCraft-rounded-6px squareCraft-items-center ">
                <div class="squareCraft-bg-494949 squareCraft-w-full squareCraft-universal squareCraft-px-2  ">
    ...
    squareCraft-rounded-6px squareCraft-border squareCraft-universal squareCraft-border-solid squareCraft-border-585858 
    squareCraft-items-center  ">
    
       <div class="squareCraft-font-size-container squareCraft-universal squareCraft-flex squareCraft-justify-between squareCraft-items-center squareCraft-flex squareCraft-items-center  
    ...
    <div class="squareCraft-border-r squareCraft-border-585858 "></div>
                ...
                <div class="squareCraft-mt-2 squareCraft-grid squareCraft-px-2 squareCraft-w-full squareCraft-grid-cols-12 squareCraft-gap-2 ">
                    <div class="squareCraft-flex squareCraft-col-span-7 squareCraft-justify-between squareCraft-border squareCraft-border-solid squareCraft-border-585858 squareCraft-rounded-6px squareCraft-items-center ">
